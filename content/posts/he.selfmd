...
> 整理梁文锋流传的52条言论：不做超级App、不追求利润最大化、坚持开源、不做3D/视频生成/世界模型。克制是一种战略，用来换取做成 AGI 的概率。
...
- [目录](#目录)
- [1. DeepSeek 只有一条主线](#1-deepseek-只有一条主线)
- [2. 先实现持续学习，再AI自迭代，终点是具身智能](#2-先实现持续学习再ai自迭代终点是具身智能)
- [3. 离彻底转向商业化仍然很遥远](#3-离彻底转向商业化仍然很遥远)
- [4. 开源是我们这个规模公司的sweet point](#4-开源是我们这个规模公司的sweet-point)
- [5. 中美差距不在人才](#5-中美差距不在人才)
- [6. 模厂竞争，成本排在第一位](#6-模厂竞争成本排在第一位)
- [7. 无意于成为下一个超级app](#7-无意于成为下一个超级app)
- [8. 保持团队的稳定性是核心](#8-保持团队的稳定性是核心)
- [9. 怀着对世界的善意](#9-怀着对世界的善意)
- [10. 克制让我们更能做成AGI](#10-克制让我们更能做成agi)
